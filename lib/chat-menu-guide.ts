const MENU_RESPONSES = {
  ...
  talk:
    '대화 방법 메뉴에서는 구역별 대화 방법 제안 자료를 PDF와 링크로 확인할 수 있습니다. 대시보드의 대화 방법 카드 또는 하단 탭 대화방법에서 열 수 있습니다. 관리자는 파일 업로드/수정/삭제와 대화 방법 링크 수정이 가능합니다.',
  notice:
    '공지사항 메뉴에서는 캠페인 운영 공지를 최신순으로 확인할 수 있습니다. 대시보드의 공지사항 카드 또는 하단 탭 공지에서 열 수 있습니다. 관리자는 공지 등록/수정/삭제와 상단 고정 설정을 할 수 있습니다.',
  dashboard:
    '대시보드는 캠페인 핵심 메뉴의 시작 화면입니다. 봉사 마련, 비상 연락, 구역 지도, 호별 카드, 대화 방법, 공지사항 메뉴를 카드 형태로 바로 이동할 수 있습니다. 최근 공지사항 미리보기와 우측 하단 챗봇 버튼도 함께 제공합니다.',
} as const;
